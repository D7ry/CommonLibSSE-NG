...
namespace RE
{
	Actor* CombatBehaviorController::GetCurrentAttacker()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46114, 0) };  
		return func();
	}
	...
	CombatController* CombatBehaviorController::GetCurrentCombatController()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46113, 0) };  
		return func();
	}
	...
	CombatGroup* CombatBehaviorController::GetCurrentCombatGroup()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46112, 0) };  
		return func();
	}
	...
	CombatInventory* CombatBehaviorController::GetCurrentCombatInventory()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46111, 0) };  
		return func();
	}
	...
	CombatState* CombatBehaviorController::GetCurrentCombatState()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46110, 0) };  
		return func();
	}
