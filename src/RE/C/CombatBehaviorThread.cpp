...
namespace RE
{
	CombatBehaviorThread::CombatBehaviorThread(CombatBehaviorController* parent_control, CombatBehaviorThread* parent_thread)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46226, 0) };  
	...
	CombatBehaviorThread::~CombatBehaviorThread()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46227, 0) };  
		func(this);
	}
	...
	void CombatBehaviorThread::Abort()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46237, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::AddChildThread(CombatBehaviorThread* thread)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46251, 0) };  
	...
	{
		using func_t = void(CombatBehaviorThread*);
		REL::Relocation<func_t> func{ RELOCATION_ID(46229, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::Ascend(CombatBehaviorTreeNode* node)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(529915, 0) };  
	...
	bool CombatBehaviorThread::CheckRelated(CombatBehaviorThread* other) const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46235, 0) };  
	...
	bool CombatBehaviorThread::CheckParent(CombatBehaviorThread* is_parent) const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46234, 0) };  
	...
	void CombatBehaviorThread::Descend(uint32_t ind)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46230, 0) };  
	...
	void CombatBehaviorThread::Descend(CombatBehaviorTreeNode* node)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46231, 0) };  
		return func(this, node);
	}
	...
	bool CombatBehaviorThread::GetAscendingUpdate() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46233, 0) };  
		return func(this);
	}
	...
	uint32_t CombatBehaviorThread::GetChildIndex() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46531, 0) };  
		return func(this);
	}
	...
	bool CombatBehaviorThread::GetInitialUpdate() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46232, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::Resume()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46236, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::SetAborted()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46243, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::SetFailed(bool failed)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46240, 0) };  
	...
	void CombatBehaviorThread::Suspend()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46238, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::Update()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46228, 0) };  
		return func(this);
	}
	...
	void CombatBehaviorThread::Unsuspend()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(46239, 0) };  
		return func(this);
	}
}
